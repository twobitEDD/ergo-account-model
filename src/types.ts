...
export type AccountBootstrapSource =
  | "local-register"
  | "local-login"
  | "dynamic-bridge"
  | "sync-bootstrap"
...
export type ResolveAccountSigners<TDynamicUser = unknown, TVault = unknown> = (
  input: SignerResolutionInput<TDynamicUser, TVault>
) => AccountSigner[];
