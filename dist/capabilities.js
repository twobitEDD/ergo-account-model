const toLayerStatus = (eligible) => (eligible ? "active" : "inactive");
const buildRewardsLayer = (sessionActive, walletBound, walletRequirement) => {
...
const buildWageringLayer = (sessionActive, walletBound, walletRequirement) => {
...
export const buildProgressiveAccountCapabilities = (input) => {
    var _a, _b;
    const rewardsWalletRequirement = (_a = input.rewardsWalletRequirement) !== null && _a !== void 0 ? _a : "recommended";
    const wageringWalletRequirement = (_b = input.wageringWalletRequirement) !== null && _b !== void 0 ? _b : "required";
